...
from Abb_robot.core import GoalEnv


try:
    import mujoco

    from Abb_robot.env.utils import mujoco_utils
    ...
    def __init__(
        ...
        self.observation_space = spaces.Dict(
            dict(
                ...
                #keeps track of the state of the task. if task is "0" it is pick and if it is "1" is place 
                tasks=spaces.Discrete(2)
            )
        )
...
class MujocoRobotEnv(BaseRobotEnv):
    ...
    def _initialize_simulation(self):
        ...
        #will keep track of the current task
        self.current_task=0
        #keeps track of the current state of the actuator
